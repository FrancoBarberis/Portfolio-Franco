...
function ChatArea({ channel, serverName, onMenuClick, isChannelSidebarOpen }) {
  ...
  return (
    <div className="flex-1 flex flex-col bg-gray-600 min-w-0 h-full"> 
      ...
      <header className="bg-gray-700 px-3 md:px-4 pt-3 md:pt-4 pb-3 border-b border-gray-700 flex-shrink-0">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-white text-base font-semibold truncate">{channel?.channelName || 'general'}</h1>
