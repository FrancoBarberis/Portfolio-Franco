    ...
    <div className="flex flex-col items-center justify-center space-y-4 max-w-4xl mx-auto px-4">
      <div className="flex flex-col w-full max-w-2xl gap-4">
        ...
        <div className="bg-gradient-to-br from-gray-700 via-gray-600 to-gray-800 rounded-lg overflow-hidden shadow-xl relative cursor-pointer h-64 md:h-80 flex items-center justify-center group animated-inner-border">
          ...
          <div
            className="absolute inset-0 flex items-end justify-center pb-16 bg-black/40 md:bg-black/0 md:group-hover:bg-black/60 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-colors duration-500"
          >
            <div className="flex gap-4 transition-opacity duration-500">
              <a
                ...
                className="bg-gray-700 text-white px-6 py-3 rounded-lg hover:bg-gray-800 font-semibold shadow-lg transition-colors duration-200 border border-gray-600 z-10"
              >
                Ver Demo
              </a>
              <a
