...
export default function TburgerLabs() {
  ...
  <div className="bg-gradient-to-br from-gray-700 via-gray-600 to-gray-800 rounded-lg overflow-hidden shadow-xl relative h-64 md:h-80 flex items-center justify-center group animated-inner-border p-3 md:p-4">
          ...
          <div className="border-side border-left hidden lg:block"></div>
            <div className="border-side border-bottom border-blue-500 hidden lg:block"></div>
            <div className="border-side border-right border-blue-500 hidden lg:block"></div>
            <div className="border-side border-top border-blue-500 hidden lg:block"></div>
            <div className="border-side border-left border-blue-500 hidden lg:block"></div>
