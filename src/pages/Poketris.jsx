...
export default function Poketris() {
  ...
  <div className="bg-gradient-to-br from-gray-800 via-gray-900 to-gray-700 rounded-xl p-4 mb-6 shadow-lg mt-0 md:p-6 md:text-left relative border-l-4 border-purple-500" style={{boxShadow: '0 0 0 0 rgba(0,0,0,0), -8px 0 24px 2px rgba(168,85,247,0.35)'}}>
