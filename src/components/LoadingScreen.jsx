...
export default function LoadingScreen({ progress = 0 }) {
  ...
  return (
  <div className="fixed inset-0 z-50 flex flex-col items-center justify-center h-screen" style={{ background: 'radial-gradient(circle at 50% 45%, #232946 0%, #18181b 70%, #0a0a0a 100%)' }}>
